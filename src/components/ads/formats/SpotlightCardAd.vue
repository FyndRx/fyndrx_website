  ...
  >
    ...
    <div class="relative z-10 p-6 md:p-7">
      ...
      <a
        ...
        class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-bold text-white transition-all duration-200 hover:shadow-lg hover:scale-105 active:scale-95"
        :style="{ backgroundColor: accent }"
        @click="handleClick"
      >
