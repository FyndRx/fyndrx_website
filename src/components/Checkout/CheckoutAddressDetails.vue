      ...
      <div class="space-y-4">
        ...
        <div class="text-left">
          ...
          <textarea
            ...
            class="w-full px-3 py-2 rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-sm text-gray-500 dark:text-gray-400 cursor-not-allowed focus:outline-none select-none"
            required
          ></textarea>
        ...
        <div class="space-y-2">
          ...
          <div class="flex flex-wrap gap-2 items-center">
            <button
              ...
              class="px-3 py-1.5 rounded-full border text-xs font-semibold flex items-center gap-1.5 transition-all duration-300 focus:outline-none"
            ...
            <button 
              ...
              class="px-3 py-1.5 rounded-full border border-dashed border-gray-300 dark:border-gray-600 text-xs font-semibold text-gray-500 hover:text-[#246BFD] hover:border-[#246BFD] flex items-center gap-1 transition-all focus:outline-none"
            >
            ...
            <div v-if="checkout.isAddingAddress.value" class="p-3 bg-gray-50 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700/60 rounded-xl space-y-2.5 text-left overflow-hidden">
              <div class="flex items-center gap-2">
                <input 
                  ...
                  class="flex-1 px-3 py-1.5 rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-xs text-gray-900 dark:text-white focus:ring-2 focus:ring-[#246BFD]"
                />
                <button
                  type="button"
                  ...
                  class="px-3 py-1.5 bg-[#246BFD] hover:bg-[#246BFD]/90 disabled:bg-gray-300 text-white rounded-full text-xs font-bold transition-all focus:outline-none"
                >
            ...
            <div v-if="checkout.isOrderingForSomeoneElse.value" class="space-y-3 pt-3 border-t border-gray-100 dark:border-gray-700/50 overflow-hidden text-left">
              <div>
                ...
                <input 
                  ...
                  class="w-full px-3 py-2 rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-xs text-gray-900 dark:text-white focus:ring-2 focus:ring-[#246BFD]"
                />
              </div>
              <div>
