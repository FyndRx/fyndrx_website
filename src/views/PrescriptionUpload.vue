...
const form = ref<PrescriptionUploadData>({
  ...
  email: '',
  phone_number: '',
  prescription_picture: null as unknown as File,
});
...
<template>
  <div class="container px-4 pt-20 pb-10 mx-auto">
      ...
      <div class="p-6 bg-white shadow-lg dark:bg-gray-800 rounded-xl">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div>
            ...
            <div 
              class="flex justify-center px-6 pt-5 pb-6 mt-1 transition-colors border-2 border-dashed rounded-lg"
              :class="[
              ...
              <div class="space-y-1 text-center">
                <div v-if="!prescriptionPreview" class="flex text-sm text-gray-600 dark:text-gray-400">
                  <label
                    ...
                    class="relative font-medium bg-white rounded-md cursor-pointer dark:bg-gray-700 text-primary hover:text-primary/90 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary"
                  >
                ...
                <div v-else class="relative">
                  ...
                  <button
                    type="button"
                    @click="resetForm"
                    class="absolute p-1 text-white transition-colors bg-red-500 rounded-full top-2 right-2 hover:bg-red-600"
                  >
