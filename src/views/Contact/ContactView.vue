        ...
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div class="space-y-8" :class="{ 'animate-fade-in': isVisible }">
            <div class="bg-[#246BFD]/5 rounded-2xl p-8">
              ...
              <div class="space-y-4">
                <div class="flex items-start" v-if="appSettings?.contact.address">
                  ...
                  <div class="ml-3">
                    <p class="font-medium text-gray-900 dark:text-white">Head Office:</p>
                    <p class="text-gray-600 dark:text-gray-300">{{ appSettings.contact.address }}</p>
                  </div>
                </div>

                <div class="flex items-start" v-if="appSettings?.contact.tamaleAddress">
                  <svg class="h-6 w-6 text-[#FE9615] mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <div class="ml-3">
                    <p class="font-medium text-gray-900 dark:text-white">Northern Regional Office:</p>
                    <p class="text-gray-600 dark:text-gray-300">{{ appSettings.contact.tamaleAddress }}</p>
                  </div>
                </div>

                <div class="flex items-center" v-if="appSettings?.contact.hours">
                  ...
                  <div class="ml-3">
                    ...
                    <p class="text-gray-600 dark:text-gray-300">{{ appSettings.contact.hours }}</p>
                  </div>
                </div>

                <div class="flex items-center" v-if="appSettings?.contact.email">
                  <svg class="h-6 w-6 text-[#246BFD] dark:text-[#5089FF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <a :href="'mailto:' + appSettings.contact.email" class="ml-3 text-gray-600 dark:text-gray-300 hover:text-[#246BFD] dark:hover:text-[#5089FF]">
                    {{ appSettings.contact.email }}
                  </a>
                </div>

                <div class="flex items-center" v-if="appSettings?.contact.phone">
                  <svg class="h-6 w-6 text-[#246BFD] dark:text-[#5089FF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <a :href="'tel:' + appSettings.contact.phone" class="ml-3 text-gray-600 dark:text-gray-300 hover:text-[#246BFD] dark:hover:text-[#5089FF]">
            ...
            <div class="p-8 bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
              ...
              <div class="flex space-x-4">
                <template v-for="social in defaultSocialLinks" :key="social.name">
                  <a 
                    v-if="appSettings?.socials[social.key as keyof AppSettings['socials']]"
                    :href="appSettings.socials[social.key as keyof AppSettings['socials']]"
                    target="_blank"
    ...
    <section class="py-16 bg-gray-50 dark:bg-gray-900">
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="mb-8 text-center">
          ...
          <p class="mt-2 text-lg text-gray-600 dark:text-gray-300" v-if="appSettings?.contact.address">
        ...
        <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
          <div class="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div class="p-8 bg-[#246BFD]/5 dark:bg-[#246BFD]/10">
              ...
              <div class="space-y-6">
                <div class="flex items-start gap-3" v-if="appSettings?.contact.address">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ appSettings.contact.address }}</p>
                  </div>
                </div>
