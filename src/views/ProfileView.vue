    ...
    <div class="container mx-auto px-4 max-w-6xl">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-4 space-y-6">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg border border-red-100 dark:border-red-900/20">
            ...
            <button
              ...
              class="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-full border border-red-200 dark:border-red-900/30 text-red-600 dark:text-red-400 font-bold text-sm hover:bg-red-50 dark:hover:bg-red-950/20 transition-all"
            >
