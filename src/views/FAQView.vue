...
const staticFaqs: HelpArticle[] = [
  ...
  { id: 12, slug: 'prescription-refill', is_faq: true, title: 'Can I reorder a past prescription through FyndRx?', content: 'Yes. Your prescription history is saved in your account under "My Prescriptions". From there you can view the details of a past prescription and quickly add its medications to a fresh cart to reorder. If your prescription has expired, you\'ll need a new one from your prescribing doctor or our teleconsultation service before we can dispense it again.', category: 'Prescriptions' },
  // Payments & Security
